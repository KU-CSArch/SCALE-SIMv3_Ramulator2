...
void DDR4::init_speed()
{
    ...
    const static int REFI_TABLE[5] = {6240, 7280, 8320, 2340, 12480};

    //1170 2340	3510	4680	5850	7020	8190	9360 (Default)	10530	11700	12870	14040	15210	16380	17550	18720
    ...
    //insert debug prints
    std::cout << "DDR4 RFC Value " << speed_entry.nRFC << std::endl;
    std::cout << "DDR4 REFI Value " << speed_entry.nREFI << std::endl;
