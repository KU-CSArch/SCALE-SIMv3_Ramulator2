...
python3 scalesim/scale.py -c ./configs/google.cfg -t ${topology} > ${1}_${2}_orig_out
echo "Running dram_sim.py"
python3 scripts/dram_sim.py -run_name GoogleTPU_v1_ws
python3 scripts/dram_latency.py
python3 scalesim/scale.py -c ./configs/google_ramulator.cfg -t ${topology} > ${1}_${2}_stall_out
